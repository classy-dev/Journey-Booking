...
class Iati_flight extends MX_Controller {
	...
	public function search(){
		...
		$check = isset($_GET['arrival']) ? true : false;



		$iati_origin = json_decode($_GET['iorigin']);

		$iati_destination = json_decode($_GET['idestination']);
		...
		if(!(isset($iati_origin) && isset($iati_destination))){
			...
			$this->session->set_userdata(array(
				...
				'dest' => $_GET['idestination'],

				'fromDate' =>  $_GET['departure'],

				'returnDate' =>  $_GET['arrival'],

				'adult' =>  $_GET['totalPassenger']
			...
			$this->session->set_userdata(array(
				...
				'orig' => $iati_origin->code,

				'dest' => $iati_destination->code,
		...
		$params = array(
			...
			"fromAirport" => isset($iati_origin) ? $iati_origin->code : $_GET['iorigin'],

			"allinFromCity" => true,

			"toAirport" => isset($iati_destination) ? $iati_destination->code : $_GET['idestination'],
