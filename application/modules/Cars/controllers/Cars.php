...
$this->setMetaData($this->data['module']->title,$this->data['module']->metadesc,$this->data['module']->keywords);
                    ...
                    if($html) {
                        return $this->theme->view('modules/cars/details', $this->data, $this, true);
                    } else {
                        $this->theme->view('modules/cars/details', $this->data, $this);
                    }
				}
				else {
						$this->listing();
		...
		function listing($offset = null) {
				...
				$this->theme->view('modules/cars/listing', $this->data, $this);
