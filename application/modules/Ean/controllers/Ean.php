...
// $this->session->sess_destroy();
		...
		public function index() {
				...
				$this->theme->view('modules/expedia/listing', $this->data, $this);
		}
...
*/
		...
		function loadMore() {
				...
				$this->theme->partial('modules/expedia/morehotels', $this->data);
		}
		...
		public function hotel($hotelId, $customerSessionId) {
			...
			if($isValidLang){
              ...
              /*  echo "<pre>";
				...
				$this->theme->view('modules/expedia/details', $this->data, $this);
		}
