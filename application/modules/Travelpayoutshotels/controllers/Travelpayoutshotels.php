...
class Travelpayoutshotels extends MX_Controller {
    ...
    public function index() 
    {
      ...
      if ($loadheaderfooter == "no" || $isMobile == "yes") {
        $this->theme->partial('modules/travelpayouts/hotel/index', $this->data);
      }
      else {
        $this->theme->view('modules/travelpayouts/hotel/index', $this->data, $this);
      }
    }
    ...
    public function mobile()
    {
      ...
      $this->theme->view('modules/travelpayouts/hotel/mobile', $this->data,$this);
    }
}
