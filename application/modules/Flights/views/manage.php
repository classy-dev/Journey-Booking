...
<form class="form-horizontal tour-form submitfrm" method="POST" action="" enctype="multipart/form-data"  onsubmit="return false;" >
    <div class="panel panel-default">
            ...
            <div class="tab-content form-horizontal">
                <div class="tab-pane wow fadeIn animated active in" id="GENERAL">
                    ...
                    <div class="row form-group">
                        ...
                        <label class="col-md-1 control-label text-left">Total Hours</label>
                        <div class="col-md-2">
                        ...
                        <label class="col-md-1 control-label text-left">Vat Tax</label>
                        <div class="col-md-2">
                            <div class="input-group">
                        ...
                        <label class="col-md-1 control-label text-left">Deposite</label>
                        <div class="col-md-2">
                            <div class="input-group">
                                <span class="input-group-addon">%</span>
                    ...
                    <div class="row form-group">
                        <label class="col-md-1 control-label text-left">Flight Type</label>
                        <div class="col-md-2">
                        ...
                        <label class="col-md-1 control-label text-left">Refundable</label>
                        <div class="col-md-2">
                        ...
                        <label class="col-md-1 control-label text-left">Direction</label>
                        <div class="col-md-2">
        ...
        <div class="panel-footer">
            ...
            <button type="submit"  class="btn btn-primary" id="<?php echo $submittype; ?>"> Submit </button>
        </div>
    </div>
</form>
<!--Form is Ending here-->
