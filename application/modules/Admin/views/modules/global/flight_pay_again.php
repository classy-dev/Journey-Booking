<?php 
    session_start(); 
    $single_ticket_price = $booking_data[0]->single_ticket_price;
    $booking_id = $_SESSION['booking_id']; 
    //$data = $_SESSION['POSTDATA']; 
    $adults = $booking_data[0]->adults;
    $childs = $booking_data[0]->childs;
    $infants = $booking_data[0]->infants;
    $flight_type = $booking_data[0]->flight_type;
    $customerfirstname = $booking_data[0]->custfirstname;
    $customermiddlename = $booking_data[0]->custmiddlename;
    $customerlastname = $booking_data[0]->custlastname;
    $mobile = $booking_data[0]->custphone;
    $email = $booking_data[0]->custemail;
    $location_to = $booking_data[0]->location_to;
    $location_from = $booking_data[0]->location_from;
    $location_to_code = $booking_data[0]->location_to_code;
    $location_from_code = $booking_data[0]->location_from_code;

    $total_segments = count($segments_data);


    $cabin_type = $segments_data[0]->cabin_type;
    $depart_date_1 = $segments_data[0]->depart_date;
    $depart_time_1 = $segments_data[0]->depart_time;

    $arrive_date_1 = $segments_data[0]->arrive_date;
    $arrive_time_1 = $segments_data[0]->arrive_time;
    ...
    $carrier_name_1 = $segments_data[0]->carrier_name;
    $carrier_img_1 = $segments_data[0]->carrier_img;
    $carrier_name_2 = '';
    $carrier_img_2 = '';
    $i=1;
    $k=1;
    ...
    {
        if($segments_data[$i]->segment_type=="Outbound")
        {
            $arrive_date_1 = $segments_data[$i]->arrive_date;
            $arrive_time_1 = $segments_data[$i]->arrive_time;
            $k++;
        }
    ...
    {
        $depart_date_2 = $segments_data[$k]->depart_date;
        $depart_time_2 = $segments_data[$k]->depart_time;
        
    }
    for($i=1;$i<=$total_segments;$i++)
    {
        
        if($segments_data[$i]->segment_type=="Inbound")
        {
            $arrive_date_2 = $segments_data[$i]->arrive_date;
            $arrive_time_2 = $segments_data[$i]->arrive_time;
            $carrier_name_2 = $segments_data[$i]->carrier_name;
            $carrier_img_2 = $segments_data[$i]->carrier_img;
        }
    }
...
if(response.gateway === 'mollie'){
  ...
  $('.pay_now').click(function(){
    ...
    $('#pay').addClass('in');
    $(".creditcardform").hide();
    $.post("<?php echo base_url(); ?>flights/Flights/updateBilling",$("#Billing_form").serialize(), function(response)
    {
