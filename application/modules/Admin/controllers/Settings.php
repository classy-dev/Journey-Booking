...
//  $this->data['msg'] =  $this->Settings_model->pt_install_theme();
   ...
   {
	require_once  FCPATH.'/config/currency.php';
	   ...
	   $result = (array)json_decode(file_get_contents('http://apilayer.net/api/live?access_key='.$currency_key.'=USD&currencies=' . $send_currency))->quotes;
