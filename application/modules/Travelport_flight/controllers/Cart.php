...
//        try {
			...
			$response = array(
				'status' => 'success',
				'body' => $this->theme->partial('modules/travelport/flight/cart_checkout', $this->data, TRUE),
			);
//		}
//		//catch exception
//		catch(Exception $e) {
...
//		}
    ...
    public function placeorder()
    {
        try {
            ...
            $invoice_body = $this->theme->partial('modules/travelport/flight/invoice', $this->data, TRUE);
