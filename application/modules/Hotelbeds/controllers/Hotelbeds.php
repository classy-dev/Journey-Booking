...
class Hotelbeds extends MX_Controller
{
    ...
    public function index(...$args)
    {
        ...
        try {
            ...
            $this->theme->view('modules/hotelbeds/listing', $this->data, $this);
        } catch (Exception $e) {
            echo $e->getMessage();
        }
    }
        ...
        try {
            ...
            if(isset($response) && ! empty($response)) {
                ...
                $this->output->set_output(json_encode([
                    'status' => 'success',
                    'listHtml' => $this->theme->partial('modules/hotelbeds/listing', $this->data, $this)
                ]));
            } else {
                $this->output->set_output(json_encode([
                    'status' => 'fail'
...
//                array_push($boards->board, $key);
    ...
    public function detail(...$args)
    {
        ...
        $this->theme->view('modules/hotelbeds/details', $this->data, $this);
    }
    ...
    public function checkout($cache = 0)
    {
        ...
        $this->theme->view('modules/hotelbeds/checkout', $this->data, $this);
    }
    ...
    public function invoice($invoice_id = 0, $session_id = 0)
    {
        ...
        $this->theme->view('modules/hotelbeds/invoice', $this->data, $this);
    }
