...
function my_baseURL(){
        ...
        else $base_url = 'https://tripmeng.com/';
        return $base_url;
    }
    ...
    define('PT_VERSION', 'v7.1');
    define('PT_LINK', 'http://phptravels.com');
    define('PT_SHOW', '1');
    define('PT_STARS_ICON', "<i class='star fa fa-star'></i>");
    define('PT_EMPTY_STARS_ICON', "<i class='star star fa fa-star-o'></i>");
