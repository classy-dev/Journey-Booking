...
$route['admin/flights/view'] = 'flights/flightsback/viewdetails';// For index page
$route['admin/flights/delete'] = 'flights/flightsback/delete';// For index page
$route['admin/flights/uploadTicket'] = 'flights/flightsback/uploadTicket';// For index page
$route['admin/flights/changeStatus'] = 'flights/flightsback/changeStatus';// For index page
$route['admin/flights/ResendTicket'] = 'flights/flightsback/ResendTicket';// For index page
$route['flights/bookingstatus'] = 'flights/flights/bookingstatus';// For index page
$route['admin/flights/SendVerificationEmail'] = 'flights/flightsback/SendVerificationEmail';// For index page
$route['admin/flights/processing'] = 'flights/flightsback/processing';// For index page
...
$route['flights/Flights/addBilling'] = 'flights/Flights/addBilling';// For index page
$route['flights/Flights/updateBilling'] = 'flights/Flights/updateBilling';// For index page
...
$route['admin/flightsbookings'] = 'flights/flightsback/flightsbookings'; // For index page
$route['admin/flightsdiscounts'] = 'flights/flightsback/flightsdiscounts'; // For index page

$route['flights/faq'] = 'flights/flights/faq';// For index page
$route['flights/jobs'] = 'flights/flights/jobs';// For Jobs
// Iati
...
$route['flights/flightsbooking'] = 'flights/flights/flightsbooking'; // For index page
$route['flights/bookingconfirm'] = 'flights/flights/bookingconfirm';// For index page
$route['flights/bookingnotconfirm'] = 'flights/flights/bookingnotconfirm';// For index page
$route['flights/paynow'] = 'flights/flights/paynow'; // For index page
$route['flights/payagain'] = 'flights/flights/payagain'; // For index page
...
//KiwiTaxi
$route['admin/Ktaxi(.*)'] = 'Kiwitaxi/KiwitaxiBack$1';