                ...
                <div class="acc_section">
                                        ...
                                        <div class="panel">
                                            ...
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    <label for="passenger_name_0">Name</label>
                                                    <input type="text" id="passenger_name_0" name="passenger[name]" class="form-control" placeholder="Name">
                                                </div>
                                                <div class="form-group">
                                                    <label for="passenger_age_0">Age</label>
                                                    <input type="text" id="passenger_age_0" name="passenger[age]" class="form-control" placeholder="Age">
                                                </div>
                                                <div class="form-group">
                                                    <label for="passenger_passport_0">Passport number</label>
                                                    <input type="text" id="passenger_passport_0" name="passenger[passportnumber]" class="form-control" placeholder="Passport number">
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="col-md-4 summary">
                                    ...
                                    <div class="col-md-8">
                                        <div class="row">
                                            ...
                                            for($tindex = 0; $tindex<count($transcat);$tindex++){
                                                ?>
                                                <h6 class="m0"><strong> <?php echo $transcat[$tindex];?> <?php if($tindex != count($transcat)-1){ ?><i class="fa fa-arrow-right RTL"></i><?php }?></strong></h6> <?php }?>
                                            <p  class="m0"> </p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div>
                                    <strong> <?php echo trans('0271');?> <?php echo trans('0275');?></strong> : <span class="pull-right"><?php echo $module->tourDays;?></span>
                                    <div><strong> <?php echo trans('0271');?> <?php echo trans('0122');?></strong> : <span class="pull-right"><?php echo $module->tourNights;?></span>
                                    </div>
                                    <hr>
                                    <div class="clearfix"></div>
