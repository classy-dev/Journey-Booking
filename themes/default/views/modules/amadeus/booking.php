...
<div class="container">
    ...
    <form action="<?php echo site_url("amadeus/invoice"); ?>" method="post" id="booking_form" >
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="input-group">
                                    <span class="input-group-addon"><?php echo trans('090'); ?></span>
                                    <input class="form-control" type="text" required="required" name="firstname" value="">
                                </div>
                                <br>
                                <div class="input-group">
                                    <span class="input-group-addon"><?php echo trans('091'); ?></span>
                                    <input class="form-control" type="text" required="required"  name="lastname" value="">
                                </div>
                                <br>
                                <div class="input-group">
                                    <span class="input-group-addon"><?php echo trans('094'); ?></span>
                                    <input class="form-control" type="text" required="required"  name="email" id="email" value="">
                                </div>
                                <br>
                                <div class="input-group">
                                    <span class="input-group-addon"><?php echo trans('0175')." ".trans('094'); ?></span>
                                    <input class="form-control" type="email" required="required" id="cemail" name="confirmemail" value="">
                                </div>
                                <br>
                                <div class="input-group">
                                    <span class="input-group-addon"><?php echo trans('092'); ?></span>
                                    <input class="form-control" type="text" required="required" name="phone" value="">
                                </div>
                                <br>
                                <div class="input-group">
                                    <span class="input-group-addon"><?php echo trans('098'); ?></span>
                                    <input class="form-control" type="text" required="required" name="address" value="">
                                </div>
                                <br>
                                <div class="input-group" style="border:1px solid #C7C7C7">
                                    <span class="input-group-addon"><?php echo trans('0105'); ?></span>
                                    <?php // print_r($countries); ?>
                                    <select class="select2" style="width:100%" name="country" required="required">
                               ...
                               <div class="form-group">
                                <div class="col-md-2">
                                    <label class="required go-right hidden-xs"><?php echo trans('0178'); ?></label>
                                </div>
        ...
        <br>
        <div class="col-md-12">
            <div class="panel panel-white panel-body text-center">
               <div class="col-md-4"><strong><i class="fa fa-support"></i> <?php echo trans('0382'); ?></strong></div>
               <div class="col-md-4"><i class="fa fa-envelope-o"></i> <?php echo $contactemail; ?></div>
               <div class="col-md-4"><i class="fa fa-phone"></i> <?php echo $phone; ?></div>
               <div class="clearfix"></div>
           </div>
       </div>
   </div>
