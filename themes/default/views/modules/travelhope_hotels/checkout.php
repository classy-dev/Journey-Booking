<style>body{background:#eee} .account-section { margin-bottom: 17px; margin-top: 10px; }</style>
<div class="container booking" id="thhotels">
    ...
    <br/>
    <div class="row">
        <form name="bookingForm" action="<?=base_url('thhotels/booking')?>" method="post">
            <div class="col-md-8">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="phone_number" name="number" value="" required maxlength="12" minlength="4" placeholder="Phone Number" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-4 summary">
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                <h6 class="m0"><strong><?=$hotel->company_name?></strong></h6>
                                <p  class="m0"><?=$hotel->address?></p>
                                <p  class="m0">
                        ...
                        <div class="col-md-12">
                            <div class="hotel_details_panel__checkout">
                                <ul class="no-margin no-padding">
                                    <li><b> <?php echo trans('07');?> <?php echo trans('08');?></b><span class="pull-right"><?=$searchForm->getCheckin()?></span></li>
                                    <li><b> <?php echo trans('09');?> <?php echo trans('08');?></b><span class="pull-right"><?=$searchForm->getCheckout()?></span></li>
                                    <li><b> <?php echo trans('0276');?> </b> <span class="pull-right"><?=$searchForm->getTotalNight()?></span></li>
                                    <li><b> <?php echo trans('0227');?> </b> <span class="pull-right"><?=$searchForm->getTotalRooms()?></span></li>
                                </ul>
                            </div>
                        </div>
                        <br>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body m0">
                            <p class="m0">
                                <i class="fa fa-bed"></i> 01. <strong><?=$room->room_name?></strong>
                                <span class="pull-right">For <?=$searchForm->getAdults()?> <?php echo trans('010');?></span>
                            </p>
                            <hr>
                            <p class="m0"><?=$room->type?></p>
                            <hr>
                        </div>
                    </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <h4>
                                    ...
                                    <div class="pull-right"><strong><?=$hotel->currency_name.$room->price?></strong></div>
                                </h4>
                            </div>
                        </div>
                        <div class="clearfix"></div>
