...
<div class="container booking">
    <div class="row">
        <form name="bookingForm" action="<?=base_url('hotelb/booking')?>" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                ...
                                <p  class="m0"><?=$hotel_address.', '.$country_name?></p>
                                <p  class="m0">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <h4>
                                    ...
                                    <?php $currency = (in_array('hotelCurrency', $sessionHotel->room->rate))?$sessionHotel->room->rate->hotelCurrency:$sessionHotel->currency?>
                                    <div class="pull-right"><strong><?=$currency?> <?=$vfHotelbedsMarkup($sessionHotel->room->rate->net + $sessionHotel->room->rate->commission, $markupPercentage)?></strong></div>
                                </h4>
                            </div>
                        </div>
                        <div class="clearfix"></div>
    ...
    $("button[id=completeBooking]").on("click", function() {
        ...
        $.post(form.attr('action'), form.serialize(), function(response) {
            ...
            if(response.status == 'success') {
                ...
                $("button[id=completeBooking]").after('<div style="margin-top: 10px;padding: 25px;background: #fbd5d5;text-align: center;">'+response.message+'<br/><br/><a href="'+response.invoice_url+'" style="text-decoration: underline;color: green;font-weight: bold;">TRY AGAIN</a></div>');
            }
        });
    });
</script>
