                    ...
                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:300px;">
                        <tr>
                            <td align="left" valign="top" style="font-family: Tahoma; font-size: 36px;line-height: 28px;color:#002141">
                                <div style="font-size: 12px !important;height: 14px;"><strong><?php echo trans("076"); ?> <?php echo trans("08"); ?> </strong>: <?php echo $invoice->created_at; ?></div>
                                ...
                                <div style="font-size: 12px !important;height: 14px;"><strong><?php echo trans("0398"); ?></strong> <?php echo $response->booking->reference; ?></div>
                            </td>
                        </tr>
                    </table>
                </div>
                    ...
                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:300px;">
                        <tr>
                            <td align="right" valign="top" style="font-family: Tahoma; font-size: 18px; font-weight: 400; line-height: 48px;">
                               ...
                               <div style="text-transform: uppercase; letter-spacing: 0px;font-size: 12px !important;height: 4px;margin-bottom:14px"><?php echo $bookingHolder->first_name.$bookingHolder->last_name; ?></div>
                               <div style="text-transform: uppercase; letter-spacing: 0px;font-size: 12px !important;height: 4px;margin-bottom:14px"><?php echo $bookingHolder->address; ?></div>
                               <div style="text-transform: uppercase; letter-spacing: 0px;font-size: 12px !important;height: 4px;margin-bottom:14px"><?php echo $bookingHolder->mobile_code.$bookingHolder->phone_number; ?></div>
                            </td>
                        </tr>
                    </table>
                </div>
                            ...
                            <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                                    ...
                                    <td width="25%" align="left" bgcolor="#eeeeee" style="font-family: Tahoma; font-size: 16px; font-weight: 800; line-height: 24px; padding: 5px;">
                                        <small><?php echo ($invoice->hotel_location!="NULL")?$invoice->hotel_location:"";?></small>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td width="75%" align="left" style="font-family: Tahoma; font-size: 16px; font-weight: 400; line-height: 14px; padding: 5px;">
                                        <strong><?php echo trans("0435");?></strong> : <?php echo $invoice->room_name;?>
                                    </td>
                                ...
                                <tr>
                                    <td width="75%" align="left" style="font-family: Tahoma; font-size: 16px; font-weight: 400; line-height: 14px; padding: 5px;">
                                        <strong>Board Name</strong> : <?php echo $invoice->room_rate->boardName;?>
                                    </td>
                                    <td width="25%" align="left" style="font-family: Tahoma; font-size: 16px; font-weight: 400; line-height: 14px; padding: 5px;">
                                    </td>
                                </tr>
                                    ...
                                    <td width="75%" align="left" style="font-family: Tahoma; font-size: 16px; font-weight: 400; line-height: 14px; padding: 5px;">
                                        ...
                                        <table style="width: 100%; margin: 5px 0px;" border="1">
                                            ...
                                            <?php foreach ($invoice->room_rate->cancellationPolicies as $policy): ?>
                                                <tr>
                                                    <td style="padding: 5px"><?= $policy->amount ?></td>
                                                    <td style="padding: 5px"><?= $policy->from ?></td>
                                                </tr>
                                            <?php endforeach; ?>
                                            </tbody>
                                        </table>
                                ...
                                <!-- paxes -->
                                <tr>
                                    <td width="100%" align="left" style="font-family: Tahoma; font-size: 16px; font-weight: 400; line-height: 14px; padding: 5px;">
                                        <strong>PAX Detail</strong><br/>
                                        <table style="width: 100%; margin: 5px 0px;" border="1">
                                            <thead>
                                            <tr>
                                            ...
                                            <?php foreach ($invoice->room->paxes as $pax): ?>
                                                <tr>
                                                    <td style="padding: 5px"><?= $pax->name.' '.$pax->surname ?></td>
                                                    <td style="padding: 5px"><?= $pax->type ?></td>
                                                </tr>
                                            <?php endforeach; ?>
                                            </tbody>
                                        </table>
