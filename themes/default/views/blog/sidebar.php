    ...
    <div class="panel-body">
      <form action="<?php echo base_url().'blog/search'; ?>" method="GET">
        <div class="input-group RTL">
          <input style="height:40px" type="text" name="s" required placeholder="<?php echo trans('0283');?>" class="form-control sub_email">
    ...
    <div class="panel-body">
      <div class="content">
        ...
        <div class="row">
          ...
          <img style="height:50px" class="img-responsive post-img img-fade" src="<?php echo pt_post_thumbnail($post->post_id); ?>" alt="<?php echo $bloglib->title;?>" />
          </a>
