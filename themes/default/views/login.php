<style>
  ...
  .form-heading { padding: 0px 0; margin: 10px 0; padding-top: 0px; padding-bottom: 5px; font-size: 20px; }
...
<div class="">
  ...
  <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3" style="margin-bottom:100px;margin-top100px">
    ...
    <form method="POST" action="" id="loginfrm" accept-charset="UTF-8" onsubmit="return false;">
      <p>
        <img data-wow-duration="0.5s" data-wow-delay="0.5s" src="<?php echo base_url(); ?>/assets/img/admin.png" class="center-block wow fadeIn center-block" style="width: 78px; height: 60px; margin-top: 50px; margin-bottom: 20px;" alt="">
      </p>
      <div class="panel panel-default">
        <div class="panel-heading go-text-right"><?php echo trans('04');?></div>
      ...
      <button style="font-size: 16px;" type="submit" class="btn btn-action btn-lg btn-block loginbtn"><?php echo trans('04');?></button>
      <br>
      <div class="wow zoomInDown animated row">
        <?php if($registerationAllowed == "1"){ ?>
        <div class="col-md-12"><a class="btn btn-default br25 btn-block form-group" href="<?php echo base_url();?>register"><span></span><?php echo trans('0237');?></a></div>
        <?php } ?>
        <div class="clearfix form-group"></div>
        <div class="col-md-12"><a class="btn btn-default br25 btn-block"  data-toggle="modal" href="#ForgetPassword"><?php echo trans('0112');?></a></div>
      </div>
      <!-- End of Login Wrap  -->
    </form>
  </div>
