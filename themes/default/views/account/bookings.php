...
<div class="row">
    <div class="col-md-5 offset-0 go-right">
        <img alt="" class="left mr20 img-responsive go-right" style="max-width:96px;padding:5px" src="<?php echo $b->thumbnail;?>">
        <a class="dark go-right" href="#"><b><?php echo $b->title; ?></b></a> <br>
        <span class="dark size12 go-right"><?php echo $b->location;?> / <?php echo $b->stars;?></span><br>
        <span class="opensans green bold size14 go-right"><strong><small><?php echo $b->currCode;?> <?php echo $b->currSymbol;?></small><?php echo $b->checkoutTotal;?></strong></span><br>
        <small><span class="grey go-right"><?php echo $b->date;?></span></small><br>
    </div>
