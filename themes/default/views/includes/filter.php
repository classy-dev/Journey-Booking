      ...
      <form name="fFilters" action="<?php echo base_url().$appModule;?>/search" method="GET" role="search">
        ...
        <div id="collapse2" class="collapse in">
            <div class="panel-body text-center">
                ...
                <input type="text" class="col-md-12 price_ranger" value="" data-slider-min="<?php echo @$minprice;?>" data-slider-max="<?php echo @$maxprice;?> " data-slider-step="100" data-slider-value="[<?php echo $selectedprice;?>]" id="sl2" name="price">
            </div>
        </div>
        <!-- End of Price range -->
        <!-- Module types -->
        ...
        <div id="collapse4" class="collapse in">
            <div class="hpadding20">
                ...
                <?php @$varAmt = $_GET['amenities'];
                    ...
                    ?>
                <div class="go-right"><input type="checkbox" value="<?php echo $hamt->id;?>" <?php if(in_array($hamt->id,$varAmt)){echo "checked";}?> name="amenities[]" id="<?php echo $hamt->name;?>" class="checkbox" /><label for="<?php echo $hamt->name;?>" class="css-label go-left"> <img class="go-right amenities" src="<?php echo $hamt->icon;?>">  <?php echo $hamt->name;?></label></div>
                <div class="clearfix"></div>
                <?php } ?>
            </div>
            <div class="clearfix"></div>
        ...
        <button style="border-radius:0px;margin-bottom:0px;" type="submit" class="btn btn-danger btn-lg btn-block loader" id="searchform"><?php echo trans('012');?></button>
    </form>
<?php } } ?>