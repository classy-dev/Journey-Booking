                ...
                <div class="container hidden-xs hidden-sm">
                    <div class="carousel-caption text-center">
                        ...
                        <div class="form-group tabs">
                            ...
                            <?php  if(isModuleActive('tours')){ ?><button id="tours" class="btnz btn btn-default btn-lg showform tour_margin"><i class="icon-slideshare"></i> <?php echo trans('0271');?></button><?php } ?>
