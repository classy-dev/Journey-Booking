<ul class="nav navbar-nav navbar-side navbar-right sidebar go-left user_menu">
    <li class="">
        <a href="<?php echo base_url(); ?>flights/bookingstatus" class="go-text-right"><i class="icon_set_1_icon-66 go-right"></i>Booking Status</a>
        
    </li>
    <div class="header-brdr pull-left hidden-xs hidden-md go-left"></div>
    <?php  if(!empty($customerloggedin)){ ?>
    <li class="">
        <a href="javascript:void(0);" data-toggle="dropdown" class="dropdown-toggle go-text-right"><i class="icon_set_1_icon-70 go-right"></i> <?php echo $firstname; ?> <b class="lightcaret mt-2 go-left"></b></a>
    ...
    <li id="li_myaccount">
        <a href="javascript:void(0);" data-toggle="dropdown" class="dropdown-toggle go-text-right"><i class="icon_set_1_icon-70 go-right"></i> <?php echo trans('0146');?> <b class="lightcaret mt-2 go-left"></b></a>
        <ul class="dropdown-menu">
